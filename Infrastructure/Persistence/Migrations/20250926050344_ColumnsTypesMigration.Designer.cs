...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250926050344_ColumnsTypesMigration")]
    partial class ColumnsTypesMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.HorarioAtencion", b =>
                {
                    ...
                    b.Property<int>("DiaAtencion")
                        .HasColumnType("NUMBER(10)")
                        .HasColumnName("DIAATENCION");
            ...
            modelBuilder.Entity("HISTORIAL_TERAPEUTICO", b =>
                {
                    ...
                    b.Property<int>("SITUCACIONTERAPEUTICAID")
                        .HasColumnType("NUMBER(10)");

                    b.HasKey("PERSONAID", "SITUCACIONTERAPEUTICAID");

                    b.HasIndex("SITUCACIONTERAPEUTICAID");

                    b.ToTable("HISTORIAL_TERAPEUTICO");
                });

            modelBuilder.Entity("PRESTADORES_ESPECIALIDADES", b =>
                {
                    b.Property<int>("ESPECIALIDADID")
                        .HasColumnType("NUMBER(10)");
                    ...
                    b.ToTable("PRESTADORES_ESPECIALIDADES");
                });
            ...
            modelBuilder.Entity("HISTORIAL_TERAPEUTICO", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.SituacionTerapeutica", null)
                        .WithMany()
                        .HasForeignKey("SITUCACIONTERAPEUTICAID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
